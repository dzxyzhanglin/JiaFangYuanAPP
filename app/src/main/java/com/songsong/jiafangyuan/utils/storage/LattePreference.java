package com.songsong.jiafangyuan.utils.storage;
...
public class LattePreference {
    ...
    private static final String APP_PREFERENCES_KEY = "fang_profile";
    ...
    public static UserEntity getUserInfo() {
        JSONObject obj = LattePreference.getAppProfileJson();

        final Integer userid = obj.getInteger("userid");
        final String nickName = obj.getString("nickName");
        final String avatar = obj.getString("avatar");
    ...
    public static Integer getUserId() {
        JSONObject obj = getAppProfileJson();
