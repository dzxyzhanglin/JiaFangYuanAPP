...
public class MaiFangCreateFragment extends BaseBackFragment {
    @BindView(R2.id.toolbar)
    Toolbar mToolbar;
    @BindView(R2.id.toolbar_title)
    AppCompatTextView mTitle;
    @BindView(R2.id.et_maifang_weizhi)
    AppCompatTextView mWeizhi;

    @BindView(R2.id.maifang_step_1)
    LinearLayoutCompat mSetp1 = null;
    @BindView(R2.id.maifang_step_2)
    LinearLayoutCompat mSetp2 = null;
    @BindView(R2.id.maifang_step_3)
    LinearLayoutCompat mSetp3 = null;
    @BindView(R2.id.maifang_step_4)
    ...
    @OnClick(R2.id.btn_maifang_setp_next_2)
    void onShowNext2() {
        mSetp1.setVisibility(View.GONE);
        mSetp2.setVisibility(View.VISIBLE);
    }

    @OnClick(R2.id.btn_maifang_setp_prev_1)
    void onShowPrev1() {
        mSetp1.setVisibility(View.VISIBLE);
        mSetp2.setVisibility(View.GONE);
    }
    @OnClick(R2.id.btn_maifang_setp_next_3)
    void onShowNext3() {
        mSetp2.setVisibility(View.GONE);
        mSetp3.setVisibility(View.VISIBLE);
    }

    @OnClick(R2.id.btn_maifang_setp_prev_2)
    void onShowPrev2() {
        mSetp2.setVisibility(View.VISIBLE);
        mSetp3.setVisibility(View.GONE);
    }
    @OnClick(R2.id.btn_maifang_setp_next_4)
    void onShowNext4() {
        mSetp3.setVisibility(View.GONE);
        mSetp4.setVisibility(View.VISIBLE);
    }

    @OnClick(R2.id.btn_maifang_setp_prev_3)
    void onShowPrev3() {
        mSetp3.setVisibility(View.VISIBLE);
        mSetp4.setVisibility(View.GONE);
    }

    @OnClick(R2.id.et_maifang_weizhi)
    void onShowWeiZhi() {
     ...
     * 保存
     */
    @OnClick(R2.id.btn_maifang_save)
    void onSave() {
    ...
    public Object setLayout() {
        return R.layout.fragment_maifang_create;
    }

    @Override
    public void onBindView(@Nullable Bundle savedInstanceState, View rootView) {
        mTitle.setText(R.string.to_maifang);
