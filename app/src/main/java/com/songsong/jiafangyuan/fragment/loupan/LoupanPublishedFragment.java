...
public class LoupanPublishedFragment extends BaseBackFragment {
    ...
    public static LoupanPublishedFragment create(String data) {
        final Bundle args = new Bundle();
        args.putString(ARG_DATA, data);
        final LoupanPublishedFragment fragment = new LoupanPublishedFragment();
