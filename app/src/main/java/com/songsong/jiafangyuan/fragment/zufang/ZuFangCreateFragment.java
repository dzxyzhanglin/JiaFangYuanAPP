...
public class ZuFangCreateFragment extends BaseBackFragment {
    @BindView(R2.id.toolbar)
    Toolbar mToolbar;
    @BindView(R2.id.toolbar_title)
    AppCompatTextView mTitle;
    @BindView(R2.id.et_zufang_weizhi)
    AppCompatTextView mWeizhi;

    @BindView(R2.id.chuzu_step_1)
    LinearLayoutCompat mSetp1 = null;
    @BindView(R2.id.chuzu_step_2)
    LinearLayoutCompat mSetp2 = null;
    @BindView(R2.id.chuzu_step_3)
    LinearLayoutCompat mSetp3 = null;
    @BindView(R2.id.chuzu_step_4)
    ...
    public Object setLayout() {
        return R.layout.fragment_zufang_create;
    }

    @Override
    public void onBindView(@Nullable Bundle savedInstanceState, View rootView) {
        mTitle.setText(R.string.to_zufang);
