...
import com.songsong.jiafangyuan.data.adapter.FuWuAdapter;
import com.songsong.jiafangyuan.data.converter.FuWuDataConverter;
import com.songsong.jiafangyuan.listener.LoupanItemClickListener;
...
public class FuWuFragment extends BaseBackFragment {
    @BindView(R.id.toolbar)
    Toolbar mToolbar;
    @BindView(R.id.toolbar_search)
    SearchView mSearchView;

    @BindView(R2.id.rv_fuwu)
    RecyclerView mRecyclerView = null;
    @BindView(R2.id.srl_fuwu)
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, View rootView) {
        ...
        mRefreshHandler = RefreshHandler.create(mRefreshLayout, mRecyclerView,
                new FuWuDataConverter(), this);
    }

    private void initToolbar() {
        initToolbarNav(mToolbar);
        //设置我们的SearchView
        mSearchView.setQueryHint(getResources().getString(R.string.fuwu_search));
        ...
        mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                mRefreshHandler.firstPage("api/service_list.php?p=1&keyword=" + query);
                return true;
            }
    ...
    public void onEnterAnimationEnd(Bundle savedInstanceState) {
        ...
        // 请求第一条数据
        mRefreshHandler.firstPage("api/service_list.php?p=1&keyword=");
    }
    ...
    private void initRecyclerView() {
       ...
       // mRecyclerView.addOnItemTouchListener(
        //        LoupanItemClickListener.create(this));
    }

    @Override
    public FuWuAdapter getAdapter(String response) {
        final List<MultipleItemEntity> data =
                new FuWuDataConverter()
                        .setJsonData(response)
                        .convert();
        return new FuWuAdapter(data);
    }
}
