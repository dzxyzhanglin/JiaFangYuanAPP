...
import com.songsong.jiafangyuan.data.adapter.ZuFangListApater;
...
public class ZuFangListFragment extends BaseBackFragment {
    @BindView(R.id.toolbar)
    Toolbar mToolbar;
    @BindView(R.id.toolbar_search)
    SearchView mSearchView;

    @BindView(R2.id.rv_zufang)
    RecyclerView mRecyclerView = null;
    @BindView(R2.id.srl_zufang)
    ...
    public Object setLayout() {
        return R.layout.fragment_zufang_list;
    }
    ...
    private void initToolbar() {
        ...
        //设置我们的SearchView
        mSearchView.setQueryHint(getResources().getString(R.string.zufang_search));
    ...
    public void onEnterAnimationEnd(Bundle savedInstanceState) {
        ...
        // 请求第一条数据
        mRefreshHandler.firstPage("api/zufang_list.php?p=1&keyword=");
    }
    ...
    public MultipleRecyclerAdapter getAdapter(String response) {
        final List<MultipleItemEntity> data =
                new FangListDataConverter()
                        ...
                        .convert();
        return new ZuFangListApater(data);
    }
}
