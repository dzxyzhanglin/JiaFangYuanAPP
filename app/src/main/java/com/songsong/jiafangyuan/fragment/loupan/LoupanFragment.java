...
import com.songsong.jiafangyuan.data.adapter.LoupanAdapter;
...
public class LoupanFragment extends BaseBackFragment {
    @BindView(R.id.toolbar)
    Toolbar mToolbar;
    @BindView(R.id.toolbar_search)
    SearchView mSearchView;

    @BindView(R2.id.rv_loupan)
    RecyclerView mRecyclerView = null;
    @BindView(R2.id.srl_loupan)
    ...
    public Object setLayout() {
        return R.layout.fragment_loupan;
    }
    ...
    private void initToolbar() {
        ...
        //设置我们的SearchView
        mSearchView.setQueryHint(getResources().getString(R.string.loupan_search));
        ...
        mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                mRefreshHandler.firstPage("api/loupan_list.php?p=1&keyword=" + query);
                return true;
            }
    ...
    public void onEnterAnimationEnd(Bundle savedInstanceState) {
        ...
        // 请求第一条数据
        mRefreshHandler.firstPage("api/loupan_list.php?p=1&keyword=");
    }
    ...
    @Override
    public LoupanAdapter getAdapter(String response) {
        final List<MultipleItemEntity> data =
                new FangListDataConverter()
                        .setJsonData(response)
                        .convert();
        return new LoupanAdapter(data);
    }
}
