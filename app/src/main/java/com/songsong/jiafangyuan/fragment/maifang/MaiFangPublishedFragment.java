...
public class MaiFangPublishedFragment extends BaseBackFragment {
    ...
    public static MaiFangPublishedFragment create(String data) {
        final Bundle args = new Bundle();
        args.putString(ARG_DATA, data);
        final MaiFangPublishedFragment fragment = new MaiFangPublishedFragment();
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, View rootView) {
        ...
        mRecyclerView.addItemDecoration(
                BaseDecoration.create(Color.GRAY, 2));
    }
